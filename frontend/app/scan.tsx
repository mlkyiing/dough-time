...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "Nunito_800ExtraBold", fontSize: 20, color: colors.onSurface },
  modeRow: {
    flexDirection: "row",
    paddingHorizontal: spacing.lg,
    gap: spacing.sm,
  ...
  modeText: { fontFamily: "Nunito_700Bold", fontSize: 13, color: colors.onSurfaceSecondary },
  ...
  placeholderTitle: { fontFamily: "Nunito_800ExtraBold", fontSize: 16, color: colors.onSurface },
  placeholderSub: { fontFamily: "Nunito_400Regular", fontSize: 12, color: colors.onSurfaceSecondary, textAlign: "center" },
  previewImage: { width: "100%", height: 200, borderRadius: radius.sm, marginBottom: spacing.md },
  ...
  actionBtnText: { color: colors.onBrandPrimary, fontFamily: "Nunito_700Bold", fontSize: 13 },
  actionBtnSecondary: {
    flex: 1,
    flexDirection: "row",
    gap: 6,
  ...
  actionBtnSecondaryText: { color: colors.brandPrimary, fontFamily: "Nunito_700Bold", fontSize: 13 },
  loadingBox: { alignItems: "center", marginVertical: spacing.lg, gap: 10 },
  loadingText: { fontFamily: "Nunito_600SemiBold", color: colors.brandPrimary },
  formCard: {
    backgroundColor: colors.surfaceSecondary,
    borderRadius: radius.md,
    padding: spacing.lg,
  ...
  formTitle: { fontFamily: "Nunito_800ExtraBold", fontSize: 18, color: colors.onSurface, marginBottom: spacing.md },
  fieldLabel: { fontFamily: "Nunito_700Bold", fontSize: 12, color: colors.onSurfaceSecondary, marginBottom: 6 },
  input: {
  ...
  miniPillText: { fontFamily: "Nunito_600SemiBold", fontSize: 11, color: colors.onSurface },
  miniPillTextSelected: { color: colors.onBrandPrimary, fontFamily: "Nunito_700Bold" },
  submitBtn: {
    backgroundColor: colors.brandPrimary,
    paddingVertical: 14,
    borderRadius: radius.pill,
  ...
  submitBtnText: { color: colors.onBrandPrimary, fontFamily: "Nunito_800ExtraBold", fontSize: 15 },
  statementRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  stMerchant: { fontFamily: "Nunito_700Bold", fontSize: 14, color: colors.onSurface },
  stSub: { fontFamily: "Nunito_400Regular", fontSize: 11, color: colors.onSurfaceSecondary },
  stAmt: { fontFamily: "Nunito_800ExtraBold", fontSize: 14, color: colors.onSurface },
});
